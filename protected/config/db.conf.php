 ...
 */
  ...
  $dbconfig['dev'] = array('localhost', 'webandnet', 'root', '', 'mysql', true,'collate'=>'utf8_unicode_ci', 'charset'=>'utf8');
  $dbconfig['prod'] = array('localhost', 'webandnet', 'root', '', 'mysql', true,'collate'=>'utf8_unicode_ci', 'charset'=>'utf8');
